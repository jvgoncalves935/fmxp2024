...
public class Dialogue001 : Dialogue3D
{
    ...
    public override void Init() {
        ...
        dialogues.Add(new DialogueData("PETSFARM_001", 1, "Frank", "Anna, Bossy and Hank disappeared!", 2.5f));
        ...
        dialogues.Add(new DialogueData("PETSFARM_005", 1, "Frank", "What difference does it make? They are in danger!", 3.0f));
